...
public class PollService {
    ...
    String textUri = "mongodb://root:root@ds061701.mongolab.com:61701/cmpe273lab";
    ...
    public Poll2 createPoll(String id, String question, String started_at, String expired_at, String[] choice) {
        ...
        if(myModeratorService.checkIfId(Integer.parseInt(id)) == 1) {
            ...
            Poll2 myPoll=new Poll2(pollId, question, started_at, expired_at, choice);
    ...
    public Poll2 viewPollWithoutResult(String id) {
        ...
        if(dbObj != null) {
            ...
            return new Poll2(dbObj.get("id").toString(),dbObj.get("question").toString(),dbObj.get("started_at").toString(),
